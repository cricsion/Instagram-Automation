...
driver.find_element_by_xpath('/html/body/div[4]/div/div/div[2]').click() #clicks on the followers tab
sleep(2)
action = ActionChains(driver) 
for scroll in range(int(num_of_followers/10)+1):#scrolls all the way to the botton 
